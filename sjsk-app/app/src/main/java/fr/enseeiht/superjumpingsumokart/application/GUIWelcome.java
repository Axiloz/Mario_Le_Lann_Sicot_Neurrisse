...
import static fr.enseeiht.superjumpingsumokart.application.autopilot.AutoPilot.disable;
import static fr.enseeiht.superjumpingsumokart.application.autopilot.AutoPilot.enable;
...
public class GUIWelcome extends Activity {
    ...
    private void startRaceBtnAction(){
        if (currentDeviceService == null) {
            ...
            /* MODIFICATIONS */
            // create pop up window to ask if the user wants to use autopilot or not
            AlertDialog.Builder builder = new AlertDialog.Builder(this);
            builder.setTitle("Autopilot");
            builder.setMessage("Do you want to use autopilot?");
            builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    // create a file to save movements
                    String fn = getApplicationContext().getFilesDir().getPath()+"/movements.xml";
                    MovementRegistry.setFileName(fn);
                    MovementRegistry.createFileXML();
                    MovementRegistry.startRecord();
                    
                    Intent intent = new Intent(GUIWelcome.this, GUIGame.class);
                    intent.putExtra("autopilot", true);
                    intent.putExtra("currentDeviceService", currentDeviceService);
            ...
            builder.setNegativeButton("No", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(GUIWelcome.this, GUIGame.class);
                    intent.putExtra("autopilot", false);
                    intent.putExtra("currentDeviceService", currentDeviceService);
                    intent.putExtra("isServer", isServer);
                    disable();
                    startActivity(intent);
